  ...
  return (
    <div className="relative flex min-h-screen justify-center items-start bg-[var(--bg-color)] p-6 overflow-hidden">
      ...
      <div className="absolute -top-32 -left-32 w-96 h-96 rounded-full 
                      ...
                      transition-transform duration-500 ease-in-out hover:scale-110"></div>

      {/* Bottom-right circle: primary-dark */}
      <div className="absolute bottom-[-100px] right-[-100px] w-72 h-72 rounded-full 
                      bg-[rgba(1,108,93,0.15)]  
                      transition-transform duration-500 ease-in-out hover:scale-110"></div>

      {/* Gradient border wrapper */}
      <div className="mt-10 md:mt-16 w-full max-w-5xl rounded-2xl 
                      bg-gradient-to-br from-[var(--gradient-start)] to-[var(--gradient-end)] 
                      p-[3px] shadow-lg flex flex-col md:flex-row overflow-hidden">
        
        {/* Left: Login Form */}
        <div className="relative w-full md:w-1/2 bg-[var(--bg-color)] p-8 flex flex-col 
