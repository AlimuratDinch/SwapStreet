  ...
  const citiesFilteredByName = useMemo(
    () =>
      filteredCities.filter((c) =>
        c.name
          .toLowerCase()
          .includes(cityInputValue.trim().toLowerCase()),
      ),
        ...
        <div className="fixed inset-0 z-[200] flex flex-col bg-gray-900">
          <div className="flex-1 relative min-h-0">
            <Cropper
              ...
              onCropComplete={(_area: Area, pixels: Area) => setCropAreaPixels(pixels)}
              onCropAreaChange={(_area: Area, pixels: Area) => setCropAreaPixels(pixels)}
              minZoom={1}
              maxZoom={3}
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder={
                selectedProvinceId ? "Type to search city..." : "Select province first"
              }
